...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnSetRight = QtWidgets.QPushButton(self.centralwidget)
        self.btnSetRight.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(3)
        sizePolicy.setHeightForWidth(self.btnSetRight.sizePolicy().hasHeightForWidth())
        self.btnSetRight.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        font.setPointSize(20)
        font.setBold(True)
        font.setWeight(75)
        self.btnSetRight.setFont(font)
        self.btnSetRight.setAutoRepeatDelay(300)
        self.btnSetRight.setObjectName("btnSetRight")
        self.gridLayout.addWidget(self.btnSetRight, 1, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnSetRight.setText(_translate("MainWindow", "设置相机参数"))
